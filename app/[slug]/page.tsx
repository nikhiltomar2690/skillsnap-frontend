...
const Snap = () => {
  return (
    <section className="bg-white">
      <div className="sm:max-w-6xl px-4 py-8 mx-auto sm:py-24 sm:px-6 lg:px-8 bg-white text-black">
        ...
        >
          <div className="rounded-3xl p-6 bg-white min-w-[42.5rem]">
            <div className="header flex justify-between">
              <div className="font-sans font-medium text-2xl">Write something about yourself</div>
              <div>X</div>
            </div>
          </div> 
        </Modal>
