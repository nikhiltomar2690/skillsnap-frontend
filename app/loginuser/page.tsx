...
import { EyeIcon, EyeOffIcon, ChevronRightIcon } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <div className="relative z-10 flex flex-1 justify-center lg:justify-end items-center lg:pr-40 lg:mr-24">
        <Card className="w-full max-w-[490px] rounded-lg shadow-lg border-none">
          ...
          <CardContent className="space-y-6 pt-6 px-8 pb-8 text-black">
            <Button
              onClick={() => signIn("google")}
              variant="outline"
              className="w-full bg-white text-[#344054] text-base font-semibold border-[#D0D5DD] rounded-[8px] py-2.5 h-11"
            >
            ...
            >
              <div className="space-y-2">
                ...
                <Input
                  ...
                  {...register("email")}
                  className="w-full bg-white border border-[#D0D5DD] rounded-[8px] py-2.5 px-3.5 text-base h-11"
                />
                {errors.email && (
